<template>
  <div class="min-h-screen flex items-center justify-center bg-gray-100 p-4">
    <div class="bg-white rounded-2xl shadow-sm p-6 sm:p-8 w-full">
      ...
      <form @submit.prevent="gererLohin" class="space-y-4">
        <!-- Email -->
        <div>
          <label for="email" class="block text-blue-600 font-semibold mb-1">Email</label>
          <input
            id="email"
            type="email"
            v-model="email"
        ...
        <!-- Password -->
        <div>
          <label for="password" class="block text-blue-600 font-semibold mb-1">Password</label>
          <input
            id="password"
            type="password"
            v-model="password"
        ...
        <button
          ...
          class="w-full bg-blue-600 text-white py-3 rounded-lg font-semibold hover:bg-blue-600 disabled:opacity-50 disabled:cursor-not-allowed"
        >
      ...
      <p class="text-center text-gray-600 mt-4">
        New user?
        <router-link to="/signup" class="text-blue-600 font-semibold hover:underline">Create account</router-link>
      </p>
    </div>
  </div>
</template>
